...
import { FaPlusCircle, FaImages, FaInfoCircle, FaListUl, FaCloudUploadAlt, FaStar, FaTimes, FaTrash, FaPlus, FaCopy, FaSave, FaArrowLeft } from 'react-icons/fa';
...
import { AttributeValueSelect, PAGE_SIZE } from './ProductAddPage.jsx';
    ...
    <DndProvider backend={HTML5Backend}>
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <h1 className={styles.pageTitle}>Добавление товара</h1>
        </div>
