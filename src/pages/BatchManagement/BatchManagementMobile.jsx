...
import styles from './BatchManagementMobile.module.css';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <h1 className={styles.title}>
          {activeTab === 'batches' ? 'Партии' : 'Перемещения'}
        </h1>
        <button
          type="button"
          ...
          aria-label={activeTab === 'batches' ? 'Создать партию' : 'Создать перемещение'}
        >
          <FaPlus />
        </button>
      </div>
...
export default BatchManagementMobile;
