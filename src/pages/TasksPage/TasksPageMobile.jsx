...
import styles from './TasksPageMobile.module.css';
        ...
        <div className={`${styles.taskCard} ${task.parent_task_id ? styles.subtask : ''}`}>
            <div className={styles.taskHeader} onClick={() => setExpanded(!expanded)}>
                <div className={styles.taskTitleRow}>
                    <h3 className={styles.taskTitle} onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/business/${business_slug}/tasks/${task.id}`);
                    }}>
                        {task.title}
                    </h3>
            ...
            {expanded && (
                <div className={styles.taskBody}>
                    ...
                    <div className={styles.taskActions}>
                        ...
                        >
                            <FaUpload /> {uploadingFile === task.id ? 'Загрузка...' : 'Файл'}
                        </button>
                        <button
                            className={styles.actionButton}
                            onClick={() => onEdit(task)}
                    ...
                    {(task.subtasks_count ?? 0) > 0 && (
                        <div className={styles.subtasks}>
                            ...
                            <p className={styles.subtasksHint}>
                                Всего: {task.subtasks_count}. Откройте карточку задачи.
                            </p>
                            <button
                                type="button"
                                className={styles.actionButton}
                                onClick={() =>
                                    navigate(
                                        `/business/${business_slug}/tasks/${task.id}`
                                    )
                                }
                            >
                                <FaEye /> К задаче
