...
import { FaFileExcel, FaUpload, FaCheckCircle, FaExclamationCircle, FaSpinner, FaTimes, FaImage, FaChevronUp, FaChevronDown } from 'react-icons/fa';
import styles from './ExcelImportPageMobile.module.css';
import Loader from '../../components/Loader';
import ImageCropper from '../../components/ImageCropper/ImageCropper';

const ExcelImportPageMobile = () => {
        ...
        {!excelFile && !parsedProducts.length && (
          <div className={styles.sectionCard}>
            <div className={styles.uploadArea} onClick={() => fileInputRef.current?.click()}>
              ...
              <p className={styles.uploadHint}>Поддерживаются .xlsx, .xls</p>
            </div>
            <input
              ref={fileInputRef}
              type="file"
            ...
            <div className={styles.fileInfo}>
              ...
              <div className={styles.fileActions}>
                ...
                <button
                  ...
                  disabled={parsing}
                >
                  {parsing ? <FaSpinner className={styles.spin} /> : <FaUpload />}
                </button>
              </div>
            </div>
          </div>
        ...
        {parsedProducts.length > 0 && (
          <div className={styles.sectionCard}>
            <div className={styles.sectionHeader}>
              <h5>Товаров: {parsedProducts.length}</h5>
            </div>
                    ...
                    <div className={styles.formRow}>
                      ...
                      <div className={styles.imagesSection}>
                        ...
                        <button
                          ...
                          onClick={() => document.getElementById(`image-upload-mobile-${index}`).click()}
                        >
                                ...
                                <div key={imgIndex} className={styles.imageItem}>
                                  <div className={styles.imageControls}>
                                    <button
                                      ...
                                      onClick={() => reorderProductImages(index, imgIndex, imgIndex - 1)}
                                      disabled={imgIndex === 0}
                                      title="Вверх"
                                    >
                                      <FaChevronUp />
...
export default ExcelImportPageMobile;
