  ...
  ({
    ...
    const listClassName = useMemo(
      () =>
        [
          styles.list,
          isVertical && styles.listVertical
        ]
          .filter(Boolean)
          .join(' '),
      [isVertical]
    ...
    const itemClassName = useMemo(
      () =>
        [
          styles.item,
          isVertical && styles.itemVertical
        ]
          .filter(Boolean)
          .join(' '),
      [isVertical]
    ...
    const renderLogoItem = useCallback(
      (item, key) => {
        if (renderItem) {
          return (
            <li className={itemClassName} key={key} role="listitem">
              {renderItem(item, key)}
            </li>
          );
        }
    ...
    const logoLists = useMemo(
      ...
      [copyCount, logos, renderLogoItem, listClassName]
    );
    ...
    return (
      <div ref={containerRef} className={rootClassName} style={containerStyle} role="region" aria-label={ariaLabel}>
        <div className={trackClassName} ref={trackRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          {logoLists}
        </div>
      </div>
    );
